...
description: Rork-Max Quality skill for WATCHOS Setting up a watchOS project on watchos. Based on official Apple WatchKit Documentation.
---
...
```swift
// Premium WATCHOS Setting up a watchOS project Implementation for watchos
