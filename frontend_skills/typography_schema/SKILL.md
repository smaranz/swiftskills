---
name: Typography Schema
description: Using modern fonts (Inter, Roboto, Outfit), establishing clear hierarchy, and ensuring perfect readability and contrast.
---

# Typography Schema

Using modern fonts (Inter, Roboto, Outfit), establishing clear hierarchy, and ensuring perfect readability and contrast.
