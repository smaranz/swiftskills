...
description: Adding subtle, performant hover, focus, and active state animations to make the UI feel alive and responsive.
---

# Micro Interactions

Adding subtle, performant hover, focus, and active state animations to make the UI feel alive and responsive.
