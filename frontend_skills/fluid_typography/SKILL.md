...
description: Using clamp() and viewport units to create text that scales perfectly across device sizes without media query breakpoints.
---

# Fluid Typography

Using clamp() and viewport units to create text that scales perfectly across device sizes without media query breakpoints.
