...
def verify_skill(path):
    ...
    checks = {
        ...
        "When to Use Section": "## When to Use" in content,
        "Best Practices or Pitfalls": (
            "## Best Practices" in content or "## Common Pitfalls" in content
        ),
        "No Raw Doc Dump": "Copyright" not in content and "Terms of Use" not in content,
    }
